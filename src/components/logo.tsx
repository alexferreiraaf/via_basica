...
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <rect className="st0" width="200" height="200" fill="none" />
      <g>
        <path
          fill="#FFFFFF"
        ...
        />
        <path fill="#FFFFFF" d="M67.8,43.7L92,98.6l6.5-15l-16.4-37.8L67.8,43.7z" />
        <path fill="#FFFFFF" d="M123.7,46.7l-4.6-10.5h-20v4.3l3.6,8.3L123.7,46.7z" />
      </g>
    </svg>
  );
}
